...
//this class provides a JavaFX UI for displaying a list of customers and their details
public class CustomerListView extends Application {
    ...
    //constructor initializes the view with the customer and account controllers
    ...
    //layouts the customer table with columns and selection listener
    ...
    //loads customers from the controller and populates the table
    ...
    //displays the balance information in the result box
    private void displayCustomerDetails(Customer customer) {
        ...
        if (accounts.isEmpty()) {
            details.append("No accounts found.\n");
        } else {
